...
typedef HANDLE asc_mutex_t;

#   define asc_mutex_init(_mutex) _mutex = CreateMutex(NULL, FALSE, NULL)
#   define asc_mutex_destroy(_mutex) CloseHandle(_mutex)
#   define asc_mutex_lock(_mutex) WaitForSingleObject(_mutex, INFINITE)
#   define asc_mutex_unlock(_mutex) ReleaseMutex(_mutex)
#else
#   include <pthread.h>

typedef pthread_mutex_t asc_mutex_t;

#   define asc_mutex_init(_mutex) pthread_mutex_init(&_mutex, NULL)
#   define asc_mutex_destroy(_mutex) pthread_mutex_destroy(&_mutex)
#   define asc_mutex_lock(_mutex) pthread_mutex_lock(&_mutex)
#   define asc_mutex_unlock(_mutex) pthread_mutex_unlock(&_mutex)
#endif
...
bool asc_thread_core_loop(void)
{
    bool idle = true;
